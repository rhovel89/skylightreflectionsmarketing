...
export async function SiteBuilder(){
  ...
  return <>
    ...
    <form action={saveSiteSettings} className="admin-card">
      ...
      <div className="notice">Authoritative Canva source: design <b>DAFMpifRS1E — Skylight Reflections</b>. Add the permanent web logo URL when a durable export is available; the app keeps a local Skylight-styled fallback when this field is blank.</div>
