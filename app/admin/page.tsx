...
const quick=[
  ...
  ['/admin/revenue-stack','Revenue Stack','See subscriptions, Sponsored advertising, paid lead sales and Skylight marketing services as four separate revenue channels.'],
  ...
  ['/admin/revenue','Revenue Operations','Track paid plans, billing health, lead-sale revenue and Featured sponsorships.'],
