...
export default async function Page(){
  ...
  return <>
    ...
    <div className="grid grid-2" style={{marginBottom:18}}><div className="admin-card"><div className="kpi">Owner Workflow</div><h2>Inquiry → contact → appointment → lead sale</h2><p className="small muted">Use this desk to track your actual follow-up and appointment-setting work. Marking a lead Delivered or Sold is a manual owner record only; it does not send data, invoice Estate Legacy Pro or charge anyone automatically.</p></div><div className="admin-card"><div className="kpi">Public Funnel</div><h2>Estate Planning & Trust</h2><p className="small muted">The public page is built for nationwide estate-planning search intent and contains explicit named-partner consent and legal-services disclosures.</p><div style={{display:'flex',gap:8,flexWrap:'wrap'}}><Link className="btn btn-primary" href="/estate-planning" target="_blank">View Public Funnel</Link><a className="btn btn-light" href="https://estatelegacypro.com/" target="_blank" rel="noopener noreferrer">Estate Legacy Pro</a></div></div></div>
