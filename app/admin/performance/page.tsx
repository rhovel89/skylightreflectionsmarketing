...
export default async function Page(){
  ...
  const dealIds=[...new Set([...dealImpressionMap.keys(),...dealClickMap.keys()])].filter(Boolean).sort((a,b)=>(dealClickMap.get(b)||0)-(dealClickMap.get(a)||0)||(dealImpressionMap.get(b)||0)-(dealImpressionMap.get(a)||0)).slice(0,8)
