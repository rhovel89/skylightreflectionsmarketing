...
const releaseTrain='sales-command-center-3.5-reply-conversion-intelligence'
...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({ ok:true,service:TENANT_SLUG,version:'15.5.0',release_train:releaseTrain,database:'ok',deployment_commit:deploymentCommit(),automatic_outreach:false,billing_authorization:false,public_ranking_effect:false,reply_classification_advisory:true,response_ms:Date.now()-started },{status:200,headers:{'Cache-Control':'no-store'}})
  } catch {
