...
const releaseTrain='sales-command-center-3.7-daily-operating-system'
...
export async function GET(){
  ...
  try{
    ...
    return NextResponse.json({
      ...
      automatic_outreach:false,billing_authorization:false,public_ranking_effect:false,reply_classification_advisory:true,response_send_requires_staff_approval:true,
      calendar_event_requires_staff_action:true,calendar_invite_requires_staff_confirmation:true,paid_revenue_attribution_only:true,
      database_action_automation:true,daily_metrics_snapshots:true,first_touch_campaign_attribution:true,forecast_close_dates_staff_entered:true,
