...
export default async function Page({params}:{params:Promise<{slug:string}>}){
 ...
 const consultationHref=`/estate-planning?guide=${encodeURIComponent(g.slug)}#estate-planning-form`
