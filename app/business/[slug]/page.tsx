  ...
  return <SiteShell>
    ...
    <main>
      <section className="pagehero"><div className="container">
        <div className="badges">{b.verified && <span className="badge verified">Verified</span>}{b.is_sponsored && <span className="badge sponsored">Sponsored</span>}{b.claimed && <span className="badge neutral">Claimed</span>}</div>
